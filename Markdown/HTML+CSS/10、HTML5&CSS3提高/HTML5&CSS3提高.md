...
<img src="mark-img/b903916cbc5d4dfeb5f21741362564ba.gif" style="zoom: 50%;" />

## 1.5 H5 新增全局属性

[https://www.runoob.com/tags/ref-standardattributes.html](https://www.runoob.com/tags/ref-standardattributes.html)
...
| `<标签名>.某类名`   | `form.name`  匹配 `class='name'` 的 form表单 |
| `<标签名>#某 id 名` | `form#name`  匹配 `id='name'` 的 form表单    |
...
**总结一般nth-child在ul-li中使用  其余情况用nth-of-type**
...
filter函数：https://www.runoob.com/cssref/css3-pr-filter.html
...
transition-delay: 0.8s;  过渡延时！！！！！0.8s之后再过渡
```
