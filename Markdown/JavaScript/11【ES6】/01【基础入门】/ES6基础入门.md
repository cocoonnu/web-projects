...
```js
// 箭头函数的this没有自身的，而是指向定义位置（外层）中的this
...
- symbol的属性
  ...
  ![image-20221210171624388](C:\Users\LENOVO\AppData\Roaming\Typora\typora-user-images\image-20221210171624388.png)

当symbol的属性作为某个对象的属性时，则变成了一个函数，即`Array[Symbol.iterator]()`
...
<img src="C:\Users\LENOVO\AppData\Roaming\Typora\typora-user-images\image-20221210172122738.png" alt="image-20221210172122738" style="zoom:67%;" />



![image-20221210173119385](C:\Users\LENOVO\AppData\Roaming\Typora\typora-user-images\image-20221210173119385.png)

`xiyou[Symbol.iterator]()`已经默认封装好了
...
// 生成一个迭代器  xiyou[Symbol.iterator]()已经默认封装好了
...
就是根据迭代器原理自己封装`object[Symbol.iterator]()`

然后再调用for of 循环

```js
// 目的是利用for of循环遍历banji.stus
...
const banji = {
    ...
    // 封装banji[Symbol.iterator]()
    [Symbol.iterator]() {
        let index = 0;
        let _this = this; // this指向banji
